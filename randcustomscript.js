document.addEventListener('DOMContentLoaded', function() {
    ...
    // カート名の配列
    const kartNames = ["スタンダードカート", "スティールダイバー", "ターボ・ワン", "スケルトン", "ジェットライダー", "ブルーファルコン", "カスタムバギー", "バウザーバギー", "ピーチバギー", "ロゼッタバギー", "スリック", "ノーマルブルー", "スポンジタイヤ", "スポーツタイヤ", "スリックレッド", "スポーツブルー", "ウッド", "オフロード", "レッドウッド", "ジェット", "ジェットブルー", "スリックホワイト", "スリックブラック", "デカホイール"];
